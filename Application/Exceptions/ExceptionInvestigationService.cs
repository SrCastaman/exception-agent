...
public class ExceptionInvestigationService
{
        ...
        ExceptionInvestigation investigation)
    {
        ...
        var riskCalculation = _riskCalculationService.Calculate(
            investigation.PurchaseOrderLines,
            investigation.Inventory,
            investigation.CustomerOrders,
        ...
        return new InvestigationContext
        {
            ...
            CalculatedSeverity = riskCalculation.CalculatedSeverity,
            TotalShortageQuantity = riskCalculation.TotalShortageQuantity,
            RiskDate = riskCalculation.RiskDate
        };
    }
}